...
export default function FeactureView() {
    return (
        <section id='features' className="container-section py-20 my-10">
            ...
            <div className="grid grid-cols-2 grid-rows-4 gap-8 max-w-5xl mx-auto min-h-[400px] mt-10">
                <article className="row-span-4 bg-linear-to-br from-purple-100 via-pink-50 to-orange-100 rounded-2xl flex flex-col justify-between group relative overflow-hidden">
                ...
                <article className="row-span-2 flex flex-col items-start justify-between bg-linear-to-br from-purple-100 via-pink-50 to-orange-100 rounded-2xl group">
                    <div className="space-y-4 p-6">
                ...
                <article className="row-span-2 col-start-2 row-start-3 bg-linear-to-br from-purple-100 via-pink-50 to-orange-100 rounded-2xl p-6 flex flex-col justify-start relative overflow-hidden group">
